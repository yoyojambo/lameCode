...
#+begin_src shell
./lamecode-server --create-db --debug
#+end_src
...
#+begin_src shell
./lamecode-server --create-db --remote --db-url "libsql://your-db.turso.io"
#+end_src
...
|------------------+------------------------------------------------|
| Local DB         | ./lamecode-server --create-db                  |
| Debug Mode       | ./lamecode-server --create-db --debug          |
